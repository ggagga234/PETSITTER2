...
//				.append("<a href='http://www.sojuhanjan.com/member/emailConfirm?authKey=").append(key).append("&userid=")
				.append("<a href='http://localhost/emailConfirm?authKey=").append(key).append("&userid=")
	...
	public int replacepw(String id, String email) throws Exception { // 비밀번호 재설정
		...
		sendMail.setText(new StringBuffer().append(id).append("님의 임시 비밀번호는").append("&nbsp;<strong>").append(key)
				...
				//.append("<a href='http://www.sojuhanjan.com/'").append("' target='_blank'>뭐하냥 도와주개</a>").toString());
		.append("<a href='http://localhost/'").append("' target='_blank'>뭐하냥 도와주개</a>").toString());
		sendMail.setFrom("whatcathelpdog@gmail.com", "뭐하냥도와주개");
