		...
		var massPopChart = new Chart(myChart, {
			...
			data : {
				...
				datasets : [
						{
							label : '입금',
							data : [ ${pm.get(0)[0]},${pm.get(0)[1]}, ${pm.get(0)[2]}, ${pm.get(0)[3]}, ${pm.get(0)[4]}, ${pm.get(0)[5]}, ${pm.get(0)[6]}, ${pm.get(0)[7]}, ${pm.get(0)[8]}, ${pm.get(0)[9]}, ${pm.get(0)[10]},${pm.get(0)[11]}],
						...
						{
							label : '사용/환전',
							data : [  ${pm.get(1)[0]},${pm.get(1)[1]}, ${pm.get(1)[2]}, ${pm.get(1)[3]}, ${pm.get(1)[4]}, ${pm.get(1)[5]}, ${pm.get(1)[6]}, ${pm.get(1)[7]}, ${pm.get(1)[8]}, ${pm.get(1)[9]}, ${pm.get(1)[10]},${pm.get(1)[11]} ],
