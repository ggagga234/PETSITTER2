    ...
    e
        ...
        .extend({
            ...
            scrollParent: function () {
                var t;
                return t = e.ui.ie && /(static|relative)/.test(this.css("position")) || /absolute/.test(
                    this.css("position")
                )
                    ? this
                        .parents()
                        .filter(function () {
                            return /(relative|absolute|fixed)/.test(e.css(this, "position")) && /(auto|scroll)/.test(
            ...
            zIndex: function (i) {
                ...
                if (this.length) 
                    for (var s, a, n = e(this[0]); n.length && n[0] !== document;) {
                        if (
                            s = n.css("position"),
                            ("absolute" === s || "relative" === s || "fixed" === s) && (a = parseInt(n.css("zIndex"), 10), !isNaN(a) && 0 !== a)
                        ) 
                            return a;
                        n = n.parent()
                    }
                ...
                ? this.each(function () {
                    ...
                    return n
                        ? e.isFunction(n[r]) && "_" !== r.charAt(0)
                            ...
                            : e.error(
                                "no such method '" + r + "' for " + i + " widget instance"
                            )
                        : e.error(
                            "cannot call methods on " + i + " prior to initialization; attempted to call me" +
                            "thod '" + r + "'"
                        )
                })
                : this.each(function () {
...
(function (e) {
    ...
    e.widget("ui.mouse", {
        ...
        _mouseDestroy: function () {
            ...
            this._mouseMoveDelegate && e(document)
                .unbind(
    ...
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _mouseStart: function (t) {
            ...
            this.offsetParent = this
                .helper
                .offsetParent(),
            this.offsetParentCssPosition = this
                .offsetParent
                .css("position"),
        ...
        _createHelper: function (t) {
            ...
            s[0] === this.element[0] || /(fixed|absolute)/.test(s.css("position")) || s.css(
                "position",
                "absolute"
            ),
            s
                    ...
                    : "document" === n.containment
                        ...
                        : n.containment.constructor === Array
                            ...
                            : (
                                ...
                                i = e(n.containment),
                                s = i[0],
                                s && (t = "hidden" !== i.css("overflow"), this.containment = [
                ...
                e.each(s.sortables, function () {
                    ...
                    this
                        ...
                        ._intersectsWith(this.instance.containerCache) && (
                            ...
                            this !== o && this
                                .instance
                                ._intersectsWith(this.instance.containerCache) && e.contains(
    ...
    e
        ...
        .add("draggable", "scroll", {
            start: function () {
                ...
                t.scrollParent[0] !== document && "HTML" !== t
                    .scrollParent[0]
                    .tagName && (t.overflowOffset = t.scrollParent.offset())
            },
            drag: function (t) {
                var i = e(this).data("ui-draggable"),
                    s = i.options,
                    n = !1;
                i.scrollParent[0] !== document && "HTML" !== i
                    .scrollParent[0]
                    .tagName
                        ? (s.axis && "x" === s.axis || (
                ...
                n !== !1 && e.ui.ddmanager && !s.dropBehaviour && e
                    .ui
                    .ddmanager
                    .prepareOffsets(i, t)
            }
            ...
            start: function () {
                ...
                e(
                    ...
                    this !== t.element[0] && t
                        .snapElements
                        .push(
                            {item: this, width: i.outerWidth(), height: i.outerHeight(), top: s.top, left: s.left}
                        )
                })
            },
            drag: function (t, i) {
                ...
                for (c = p.snapElements.length - 1; c >= 0; c--) 
                    ...
                    u = l + p
                        .snapElements[c]
                        .height,
                    r - m > v || g > h + m || l - m > y || b > u + m || !e.contains(
        ...
        _updateVirtualBoundaries: function (e) {
            ...
            o = {
                minWidth: i(r.minWidth)
                    ? r.minWidth
                    : 0,
                maxWidth: i(r.maxWidth)
                    ? r.maxWidth
                    : 1 / 0,
                minHeight: i(r.minHeight)
                    ? r.minHeight
                    : 0,
                maxHeight: i(r.maxHeight)
                    ? r.maxHeight
                    : 1 / 0
            },
            (this._aspectRatio || e) && (
