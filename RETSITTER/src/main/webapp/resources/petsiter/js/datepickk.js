(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Datepickk1"] = factory();
	else
		root["Datepickk1"] = factory();
})(this, function() {
...
function Datepickk1(args) {
	Datepickk1.numInstances = (Datepickk1.numInstances || 0) + 1;
	var that = this;
	var eventName = 'click';
	var selectedDates = [];
	...
	function generateInputs() {
		...
		for (var x = 0; x < months; x++) {
			...
			for (var i = 0; i < 42; i++) {
				...
				input.type = 'checkbox';
				input.id = Datepickk1.numInstances + '-' + x + '-d-day-' + i;
				var label = document.createElement('label');
				label.setAttribute("for", Datepickk1.numInstances + '-' + x + '-d-day-' + i);
  ...
  * Datepickk1
  * Docs & License: https://crsten.github.com/Datepickk1
