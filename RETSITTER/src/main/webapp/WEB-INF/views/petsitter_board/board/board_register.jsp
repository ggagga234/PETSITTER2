<<<<<<< HEAD:RETSITTER/src/main/webapp/WEB-INF/views/petsitter_board/board/board_register.jsp
...
<body>
   ...
   <div class="site-section">
      <div class="container">
         <form action="/board/insertProc" enctype="multipart/form-data"
            method="post">
            <div class="row">
               <div class="col-lg-7">
               ...
               <div class="col-lg-4 mb-5">
                  ...
                  <div class='mb-5'
                     style="width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); padding: 20px 10px;">
                     <h3 class="h5 text-black mb-3 " style="text-align: center">
...
>>>>>>> b2951192f15074ad7e1f045f7cf5b29481d3ebff:src/main/webapp/WEB-INF/views/petsitter_board/board/board_register.jsp
</html>