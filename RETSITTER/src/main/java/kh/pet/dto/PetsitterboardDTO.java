<<<<<<< HEAD:RETSITTER/src/main/java/kh/pet/dto/PetsitterboardDTO.java
package kh.pet.dto;
...
public class PetsitterboardDTO {
	...
	public PetsitterboardDTO(String psb_seq, String psb_title, String psb_writer, Date psb_date,
			String psb_contents, String psb_thumb, String psb_service, Date psb_start_day, Date psb_end_day,
			String psb_time, String psb_petType, String psb_boardstatus) {
		super();
		this.psb_seq = psb_seq;
		this.psb_title = psb_title;
...
>>>>>>> b2951192f15074ad7e1f045f7cf5b29481d3ebff:src/main/java/kh/pet/dto/PetsitterboardDTO.java
